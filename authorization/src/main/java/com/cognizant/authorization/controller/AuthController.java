...
import com.cognizant.authorization.model.ProjectManagerDetails;
import com.cognizant.authorization.service.JwtService;
import com.cognizant.authorization.service.ProjectManagerDetailsService;
...
public class AuthController {
	...
	public ResponseEntity<String> healthCheck(){	// for Health check [PERMITTED FOR ALL]
		return new ResponseEntity<String>("Authorization MS Running Fine!!", HttpStatus.OK);
	}
